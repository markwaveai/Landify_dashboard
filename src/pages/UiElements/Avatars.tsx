...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Landify"
        description="This is React.js Avatars Dashboard page for Landify - React.js Tailwind CSS Admin Dashboard Template"
      />
