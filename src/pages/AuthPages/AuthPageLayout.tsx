...
export default function AuthLayout({
  ...
  return (
    <div className="h-screen bg-[#F0F5F2] dark:bg-gray-900 flex items-center justify-center p-0 lg:p-8 overflow-hidden">
      <div className="w-full max-w-[1100px] h-full lg:h-[90vh] lg:min-h-[650px] bg-white dark:bg-gray-800 lg:rounded-[40px] shadow-2xl dark:shadow-none overflow-hidden flex flex-col lg:flex-row border border-transparent dark:border-gray-800">
